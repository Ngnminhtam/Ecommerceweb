...
?>
                ...
                ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="9" cols="25" placeholder="Nhập tin nhắn" name="content_message"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <legend><span class="glyphicon glyphicon-globe"></span> Địa chỉ cửa hàng</legend>
                        <address>
